...
namespace MonoHook
{
    ...
    /// </summary>
    internal unsafe partial class MethodHook
    {
        public string tag;
        ...
        private void CheckMethod()
        {
            ...
            if (proxyMethod != null)
            {
                ...
                RuntimeHelpers.PrepareMethod(proxyMethod.MethodHandle);
        ...
        private IntPtr GetFunctionAddr(MethodBase method)
        {
            ...
            if (!LDasm.IsIL2CPP())
            {
                // UnityEngine.Debug.Log($"get ftn {method} {method.DeclaringType} {method.DeclaringType.Assembly}");
