...
namespace BBBirder.UnityInjection
{
    ...
    public static class WeavingUtils
    {
        ...
        public static string GetInjectedFieldName(string methodName, int methodToken) => $"{methodName}<Field>{methodToken & 0xFFFFFF:x2}";
        public static string GetOriginMethodName(string methodName, int methodToken) => $"{methodName}<UnityInjection>{methodToken & 0xFFFFFF:x2}";
        public static string GetDelegateName(string methodName, int methodToken) => $"{methodName}<Delegate>{methodToken & 0xFFFFFF:x2}";
