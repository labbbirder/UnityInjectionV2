...
namespace BBBirder.UnityInjection
{
    ...
    public abstract partial class DecoratorAttribute : InjectionAttribute
    {
        ...
        public override IEnumerable<InjectionInfo> ProvideInjections()
        {
            ...
            var originMethod = InjectionDriver.Instance.GetProxyMethod(InjectedMethod);
            ...
            var universalMethod = ThisType.GetMethod(
                ...
                null,
                new Type[] { typeof(MethodInfo), typeof(Delegate) },
                null
            );
            ...
            yield return new InjectionInfo(InjectedMethod, f => fixingFunc.Invoke(this, new object[] { originMethod, f.CastDelegate(fixingFunc.ReturnType) }) as Delegate);
        ...
        Func<R> UniversalFunc<R>(MethodInfo mi, Delegate originFunc)
        {
        ...
        Action UniversalAction(MethodInfo mi, Delegate originFunc)
        {
